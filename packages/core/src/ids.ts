...
/** The human (or service) on whose behalf agents in this session act — not an agent. */
export type Principal = Brand<string, "Principal">;
...
export const principal = (s: string): Principal => s as Principal;
